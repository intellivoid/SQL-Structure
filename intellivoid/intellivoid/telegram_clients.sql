...
(
    ...
    username      varchar(255) null comment 'The username of this Telegram User/Chat',
    ...
    constraint telegram_clients_public_id_uindex
        unique (public_id),
    constraint telegram_clients_username_uindex
        unique (username)
)
    comment 'Table of Telegram Clients that were assocaited with a Telegram Bot' charset = utf8mb4;
