...
(
    ...
    sender_chat_id                    bigint               null comment 'Sender of the message, sent on behalf of a chat',
    ...
    is_automatic_forward              tinyint(1) default 0 null comment 'True, if the message is a channel post that was automatically forwarded to the connected discussion group',
    ...
    edit_date                         timestamp            null comment 'Date the message was last edited in Unix time',
    has_protected_content             tinyint(1) default 0 null comment 'True, if the message can''t be forwarded',
    ...
    message_auto_delete_timer_changed text                 null comment 'MessageAutoDeleteTimerChanged object. Message is a service message: auto-delete timer settings changed in the chat',
    ...
    voice_chat_scheduled              text                 null comment 'VoiceChatScheduled object. Message is a service message: voice chat scheduled',
    voice_chat_started                text                 null comment 'VoiceChatStarted object. Message is a service message: voice chat started',
    voice_chat_ended                  text                 null comment 'VoiceChatEnded object. Message is a service message: voice chat ended',
    voice_chat_participants_invited   text                 null comment 'VoiceChatParticipantsInvited object. Message is a service message: new participants invited to a voice chat',
