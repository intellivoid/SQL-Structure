...
(
    ...
    max_probabilities      int          null comment 'The max amount of probabilites are allowed for each probability object',
    ...
    created_timestamp      int          null comment 'The Unix Timestamp of when this row was created',
