...
(
    ip_address             varchar(128) not null comment 'The primary IP address for this record'
        primary key,
    ip_version             int          null comment 'The verison of the IP address',
...
https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2',
    ...
    `as`                   varchar(126) null comment 'AS number and organization, separated by space (RIR). Empty for IP blocks not being announced in BGP tables.',
    asname                 varchar(255) null comment '	AS name (RIR). Empty for IP blocks not being announced in BGP tables.',
